...
<head>
    ...
    <style>
        body.admin-body { background: #eef1f4; font-family: 'IBM Plex Sans', sans-serif; }
        ...
        .admin-header h1 { color: #12161c; margin-bottom: 10px; font-family: Syne, sans-serif; letter-spacing: -0.03em; }
        .admin-header p { color: #5b6572; }
        .admin-toolbar { margin-bottom: 20px; display: flex; gap: 10px; }
        .action-btn { background: #e0952c; color: #12161c; padding: 10px 20px; border-radius: 8px; text-decoration: none; font-weight: 600; }
        ...
        .users-table th { background: #f7f8fa; font-weight: 600; }
        * { box-sizing: border-box; }
        .section-header { margin-bottom: 20px; }
        .section-header h2 { color: #12161c; font-size: 1.5rem; font-family: Syne, sans-serif; }
        .admin-top-nav {
            background: #12161c;
            color: white;
            padding: 15px 30px;
