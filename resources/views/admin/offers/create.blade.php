...
@section('content')
    <div class="admin-container">
        <div class="admin-header">
            <h1><i class="bi bi-plus-circle"></i> Create New Offer</h1>
            <p>Add a new promotional offer</p>
        </div>
        ...
        <div class="admin-section">
            <form method="POST" action="{{ route('admin.offers.store') }}" class="admin-form">
                @csrf

                <div class="form-grid">
                    <div class="form-group full-width">
                        <label>Title *</label>
                        <input type="text" name="title" value="{{ old('title') }}" required placeholder="Offer title...">
                        @error('title')
                    ...
                    <div class="form-group full-width">
                        ...
                        <textarea name="description" rows="3" placeholder="Offer description...">{{ old('description') }}</textarea>
                        @error('description')
                            <span class="error">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="discount_percentage" value="{{ old('discount_percentage', 0) }}" min="0" max="100" step="0.01">
