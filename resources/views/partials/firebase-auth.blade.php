...
<div class="auth-social" data-firebase-auth data-intent="{{ $intent ?? 'login' }}">
    ...
    <p class="auth-hint" style="margin-top:0.75rem;">
        Social sign-in creates your StudentMove account automatically and syncs it to our database. If you already registered with the same email, we link the accounts — no duplicate signup.
    </p>
</div>
